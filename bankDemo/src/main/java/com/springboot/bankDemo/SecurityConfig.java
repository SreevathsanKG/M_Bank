	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http
			...
			.authorizeHttpRequests((authorize) -> authorize
					...
					.requestMatchers("/api/executive/put").permitAll()//.hasAuthority("EXECUTIVE")
					.requestMatchers("/api/executive/get-one").permitAll()//.hasAuthority("EXECUTIVE")
					...
					.requestMatchers("/api/loan/put/status/{id}").permitAll()//.hasAnyAuthority("EXECUTIVE","MANAGER")
					.requestMatchers("/api/loan/get-by/branchId/{branchId}").permitAll()//.hasAnyAuthority("EXECUTIVE","MANAGER")
					...
					.requestMatchers("/api/loanApply/get-by/branchId/{branchId}").permitAll()//.hasAnyAuthority("EXECUTIVE","MANAGER")
					...
					.requestMatchers("/api/loanRepay/get-by/loanId/{loanId}").permitAll()//.authenticated()
					// Manager 
